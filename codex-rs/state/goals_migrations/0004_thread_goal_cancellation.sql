...
CREATE TABLE thread_goal_plans_new (
...
INSERT INTO thread_goal_plans_new (
    plan_id,
    thread_id,
    status,
    auto_execute,
...
DROP TABLE thread_goal_plans;
ALTER TABLE thread_goal_plans_new RENAME TO thread_goal_plans;
