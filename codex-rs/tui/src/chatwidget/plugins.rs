...
impl ChatWidget {
    ...
    fn marketplace_remove_confirmation_popup_params(
        ...
        header.push(Line::from(
            "This removes the configured marketplace from Codewith.".dim(),
        ));
    ...
    fn plugins_popup_params(
        ...
        tabs.push(SelectionTab {
            ...
            label: "Hasna Curated".to_string(),
            header: plugins_header(
                "Hasna Curated marketplace.".to_string(),
                format!("Installed {curated_installed} of {curated_total} Hasna Curated plugins."),
            ),
            items: self.plugin_selection_items(
                curated_entries,
                /*include_marketplace_names*/ false,
                "No Hasna Curated plugins available",
                "No Hasna Curated plugins available.",
            ),
        });
