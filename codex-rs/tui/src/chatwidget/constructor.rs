...
impl ChatWidget {
    ...
    pub(super) fn new_with_op_target(
        ...
        let mut widget = Self {
            ...
            auth_profile_usage_heartbeat_requested_at_by_profile: BTreeMap::new(),
            auth_profile_popup_rows: Vec::new(),
            auth_profile_usage_heartbeat_failed_at_by_profile: BTreeMap::new(),
            auth_profile_usage_exhausted_reset_at_by_profile: BTreeMap::new(),
            rate_limit_poller: None,
            auth_profile_auto_switch_snapshots_by_limit_id: BTreeMap::new(),
            refreshing_status_outputs: Vec::new(),
            refreshing_minimax_usage_status_outputs: Vec::new(),
            usage_panel_rate_limit_state: UsagePanelRateLimitState::default(),
            usage_panel_minimax_usage_state: UsagePanelMiniMaxUsageState::default(),
            rate_limit_reset_credits: None,
            rate_limit_reset_account_identity_fingerprint: None,
            announced_rate_limit_reset_available_count: None,
            pending_rate_limit_reset_consumption: None,
            manual_rate_limit_reset_authority: None,
            rate_limit_reset_in_flight: None,
            rate_limit_reset_retry: None,
            rate_limit_reset_generation: 0,
            pending_rate_limit_reset_picker: None,
            pending_usage_limit_auto_reset_check: None,
            ...
            thread_id: None,
            announced_loop_schedule_ids: HashSet::new(),
            status_line_schedule_thread_id: None,
            status_line_schedules_by_id: HashMap::new(),
            status_line_schedules_pending: false,
            status_line_schedules_loaded: false,
            status_line_running_schedule_ids: HashSet::new(),
            announced_monitor_ids: HashSet::new(),
