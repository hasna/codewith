...
impl ChatWidget {
    ...
    pub(super) fn approval_preset_actions(
        ...
        vec![Box::new(move |tx| {
            tx.send(AppEvent::SelectPermissionProfile(
    ...
    pub(crate) fn open_full_access_confirmation(
        ...
        let info_line = Line::from(vec![
            "When Codewith runs with full access, it can edit any file on your computer and run commands with network, without your approval. "
                .into(),
