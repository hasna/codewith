...
//! "leave the old title alone" or "clear the title Codewith last wrote".
...
pub(crate) enum SetTerminalTitleResult {
    ...
    /// the title Codewith manages, or some other fallback.
    NoVisibleContent,
}
...
/// or a previous program may have set before Codewith started managing the title.
