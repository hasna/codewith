...
use crate::multi_agents::agent_picker_row_status;
use crate::multi_agents::agent_picker_status_dot_spans;
use crate::multi_agents::format_agent_picker_entry_name;
use crate::multi_agents::format_agent_picker_metrics;
...
mod thread_loop_actions;
mod thread_monitor_actions;
mod thread_routing;
...
use self::loaded_threads::thread_spawn_agent_path;
...
fn archived_session_guidance(err: &color_eyre::eyre::Report) -> Option<String> {
    ...
    if !message.contains(" is archived. Run `codewith unarchive ") {
        return None;
    }
    let message = message
        .split_once(" (code ")
...
impl App {
    ...
    pub async fn run(
        ...
        let model_catalog = Arc::new(ModelCatalog::new_for_provider(
