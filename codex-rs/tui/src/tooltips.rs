...
const ANNOUNCEMENT_TIP_URL: &str =
    "https://raw.githubusercontent.com/hasna/codewith/main/announcement_tip.toml";
...
lazy_static! {
    static ref TOOLTIPS: Vec<&'static str> = RAW_TOOLTIPS
        ...
        .filter(|line| {
            ...
            if !IS_MACOS && !IS_WINDOWS && line.contains("codewith app") {
                return false;
            }
            true
        })
...
/// Pick a random tooltip to show to the user when starting Codewith.
    ...
    impl TargetOs {
        const fn current() -> Self {
            if cfg!(target_os = "macos") {
                ...
                // Codewith currently publishes CLI builds for macOS, Windows, and Linux.
                Self::Linux
            }
        }
    }
...
from_date = "2000-01-01"
    ...
    fn announcement_tip_toml_parse_comments() {
        let toml = r#"
# Example announcement tips for Codewith TUI.
...
[[announcements]]
content = "Welcome to Codewith! Check out the new onboarding flow."
