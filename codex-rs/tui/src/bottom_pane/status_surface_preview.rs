...
impl StatusSurfacePreviewItem {
    fn placeholder(self) -> &'static str {
        match self {
            ...
            StatusSurfacePreviewItem::ScheduleCountdown => "Next loop 4m 03s",
            StatusSurfacePreviewItem::ThreadTitle => "thread title",
            StatusSurfacePreviewItem::GoalTitle => "Ship statusline titles",
            ...
            StatusSurfacePreviewItem::AuthProfile => "work",
            ...
            StatusSurfacePreviewItem::ActiveAgent => "Main [default]",
        }
    }
