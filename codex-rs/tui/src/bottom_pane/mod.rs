...
pub(crate) use message_summary_setup::MessageSummarySetupView;
...
impl BottomPane {
    ...
    pub fn set_scheduled_tasks_command_enabled(&mut self, enabled: bool) {
        self.composer.set_scheduled_tasks_command_enabled(enabled);
        self.request_redraw();
    }
...
mod tests {
    ...
    fn test_pane_with_disable_paste_burst(
        ...
        BottomPane::new(BottomPaneParams {
            ...
            placeholder_text: "Ask Codewith to do anything".to_string(),
            disable_paste_burst,
