...
pub(super) const KEYMAP_ACTIONS: &[KeymapActionDescriptor] = &[
    ...
    action("global", "Global", "cycle_permissions", "Cycle to the next permissions preset."),
    action("chat", "Chat", "interrupt_turn", "Interrupt the active turn."),
    action("chat", "Chat", "flush_queued_messages", "Flush queued follow-ups into the active turn as one steer."),
...
pub(super) fn binding_slot<'a>(
    ...
    match (context, action) {
        ...
        ("global", "cycle_permissions") => Some(&mut keymap.global.cycle_permissions),
        ("chat", "interrupt_turn") => Some(&mut keymap.chat.interrupt_turn),
        ("chat", "flush_queued_messages") => Some(&mut keymap.chat.flush_queued_messages),
...
pub(super) fn bindings_for_action<'a>(
    ...
    match (context, action) {
        ...
        ("global", "cycle_permissions") => Some(runtime_keymap.app.cycle_permissions.as_slice()),
        ("chat", "interrupt_turn") => Some(runtime_keymap.chat.interrupt_turn.as_slice()),
        ("chat", "flush_queued_messages") => Some(runtime_keymap.chat.flush_queued_messages.as_slice()),
