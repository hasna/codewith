...
//!
//! The history is stored at `~/.codewith/history.jsonl` with **one JSON object per
...
/// Filename that stores the message history inside `~/.codewith`.
...
pub async fn append_entry(
    ...
    // Resolve `~/.codewith/history.jsonl` and ensure the parent directory exists.
