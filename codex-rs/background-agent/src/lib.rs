...
pub use codex_state::BackgroundAgentEventForSupervisorParams;
pub use codex_state::BackgroundAgentExecutionHandleParams;
pub use codex_state::BackgroundAgentExecutionSnapshot;
pub use codex_state::BackgroundAgentExecutionSnapshotForSupervisorParams;
...
pub use codex_state::BackgroundAgentStatusSnapshotForSupervisorParams;
pub use codex_state::BackgroundAgentStatusSnapshotParams;
pub use codex_state::BackgroundAgentThreadBindingParams;
pub use codex_state::BackgroundAgentWorkerWriteScope;
...
pub trait AgentEventJournal {
    ...
    fn append_event_for_supervisor(
        &self,
        params: BackgroundAgentEventForSupervisorParams<'_>,
...
impl AgentEventJournal for codex_state::StateRuntime {
    ...
    async fn append_event_for_supervisor(
        &self,
        params: BackgroundAgentEventForSupervisorParams<'_>,
    ) -> anyhow::Result<Option<BackgroundAgentEvent>> {
        self.append_background_agent_event_for_supervisor(params)
            .await
    }
...
pub trait AgentSnapshotStore {
    ...
    fn upsert_status_snapshot_for_supervisor(
        &self,
        params: BackgroundAgentStatusSnapshotForSupervisorParams<'_>,
    ...
    fn create_execution_snapshot_for_supervisor(
        &self,
        params: BackgroundAgentExecutionSnapshotForSupervisorParams<'_>,
...
impl AgentSnapshotStore for codex_state::StateRuntime {
    ...
    async fn upsert_status_snapshot_for_supervisor(
        &self,
        params: BackgroundAgentStatusSnapshotForSupervisorParams<'_>,
    ) -> anyhow::Result<Option<BackgroundAgentStatusSnapshot>> {
        self.upsert_background_agent_status_snapshot_for_supervisor(params)
            .await
    }
    ...
    async fn create_execution_snapshot_for_supervisor(
        &self,
        params: BackgroundAgentExecutionSnapshotForSupervisorParams<'_>,
    ) -> anyhow::Result<Option<BackgroundAgentExecutionSnapshot>> {
        self.create_background_agent_execution_snapshot_for_supervisor(params)
            .await
    }
