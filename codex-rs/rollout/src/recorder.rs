//! Persist Codewith session rollouts (.jsonl) so sessions can be replayed or inspected later.
...
///
/// ```ignore
/// $ jq -C . ~/.codewith/sessions/rollout-2025-05-07T17-24-21-5973b6c0-94b8-487b-a530-2aeb6098ae0e.jsonl
/// $ fx ~/.codewith/sessions/rollout-2025-05-07T17-24-21-5973b6c0-94b8-487b-a530-2aeb6098ae0e.jsonl
/// ```
#[derive(Clone)]
...
impl RolloutRecorder {
    /// List threads (rollout files) under the provided Codewith home directory.
...
fn fill_missing_thread_item_metadata(item: &mut ThreadItem, state_item: ThreadItem) {
    ...
    if item.auth_profile.is_none() {
        item.auth_profile = auth_profile;
    }
...
fn precompute_log_file_info(
    ...
    // Resolve ~/.codewith/sessions/YYYY/MM/DD path.
