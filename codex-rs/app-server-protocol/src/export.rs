...
const EXPERIMENTAL_CLIENT_METHOD_DEPENDENCY_TYPES: &[&str] = &[
    ...
    "MachineRegistryEndpointUpsert",
    "MachineRegistryEnrollmentState",
    "MachineRegistryHealthState",
    ...
    "RemoteDispatchCapability",
    "RemoteDispatchDenial",
    "RemoteDispatchDenialReason",
    "RemoteDispatchDeniedOperationClass",
    "RemoteDispatchEnqueueInstructionParams",
    "RemoteDispatchEnqueueInstructionResult",
    "RemoteDispatchListPendingInteractionsParams",
    "RemoteDispatchListPendingInteractionsResult",
    "RemoteDispatchMailboxReceiptsParams",
    "RemoteDispatchMailboxReceiptsResult",
    "RemoteDispatchOperation",
    "RemoteDispatchOperationKind",
    "RemoteDispatchOperationResult",
    "RemoteDispatchReadPendingInteractionParams",
    "RemoteDispatchReadPendingInteractionResult",
    "RemoteDispatchReceipt",
    "RemoteDispatchRedaction",
    "RemoteDispatchRespondInteractionParams",
    "RemoteDispatchRespondInteractionResult",
    "RemoteDispatchRequestStatus",
    "RemoteControlClient",
