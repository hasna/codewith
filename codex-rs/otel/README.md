...
`codex-otel` is the OpenTelemetry integration crate for Codewith. It provides:
...
that member. If propagated trace context already has the named member, Codewith
...
Codewith-specific session events. Rich session/business events should go through
...
to Statsig using Codewith-internal defaults.
