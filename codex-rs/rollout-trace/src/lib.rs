//! Trace bundle format, writer, and reducer for Codewith rollouts.
//!
//! This crate owns the trace schema. Hot-path Codewith code should depend on the
...
/// Shared recorder context for inference attempts within one Codewith turn.
...
/// Request data for the canonical Codewith tool boundary.
...
/// Append-only writer used by hot-path Codewith instrumentation.
