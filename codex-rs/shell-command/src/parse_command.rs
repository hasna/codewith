...
/// The easiest way to iterate is to add unit tests and have Codewith fix the implementation.
...
/// Tests are at the top to encourage using TDD + Codewith to fix the implementation.
mod tests {
    use super::*;
