//! Diagnoses whether Codewith update paths target the running installation.
//!
...
const GITHUB_LATEST_RELEASE_URL: &str =
    "https://api.github.com/repos/hasna/codewith/releases/latest";
const HOMEBREW_CASK_API_URL: &str = "https://formulae.brew.sh/api/cask/codewith.json";
...
fn update_action_label(context: &InstallContext) -> &'static str {
    match &context.method {
        InstallMethod::Npm => "npm install -g @hasna/codewith",
        InstallMethod::Bun => "bun install -g @hasna/codewith",
        InstallMethod::Brew => "brew upgrade --cask codewith",
