...
#[derive(Debug, Parser)]
#[command(bin_name = "codewith plugin")]
...
#[derive(Debug, Parser)]
#[command(
    bin_name = "codewith plugin add",
    after_help = "Examples:\n  codewith plugin add sample@debug\n  codewith plugin add sample --marketplace debug"
)]
...
#[derive(Debug, Parser)]
#[command(
    bin_name = "codewith plugin list",
    after_help = "Examples:\n  codewith plugin list\n  codewith plugin list --marketplace debug\n  codewith plugin list --json\n  codewith plugin list --available --json"
)]
...
#[derive(Debug, Parser)]
#[command(
    bin_name = "codewith plugin remove",
    after_help = "Examples:\n  codewith plugin remove sample@debug\n  codewith plugin remove sample --marketplace debug"
)]
