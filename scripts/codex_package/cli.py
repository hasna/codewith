"""Command-line interface for building Codewith package directories."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Build a canonical Codewith package directory and optional archive.",
...
def main() -> int:
    ...
    for archive_output in args.archive_output:
        ...
        print(f"Built Codewith package archive at {archive_path}")

    print(f"Built Codewith package directory at {package_dir}")
    return 0
