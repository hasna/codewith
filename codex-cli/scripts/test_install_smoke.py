...
the affected package manager is skipped rather than failed. Set ``CODEWITH_SMOKE_STRICT=1``
in CI so a broken offline install fails instead of reporting a skipped smoke.
...
STRICT_OFFLINE_INSTALL = os.environ.get("CODEWITH_SMOKE_STRICT") == "1"
