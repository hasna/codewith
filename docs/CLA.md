# Individual Contributor License Agreement (v1.0, Hasna)
...
past and future "Contributions" submitted to the **Codewith project
(the "Project")**.
...
You grant **Hasna** and all recipients of software distributed by the
...
You grant **Hasna** and all recipients of the Project a perpetual,
