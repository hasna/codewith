...
enum SnapshotCatalog {
    static var items: [SnapshotItem] {
        ...
        return [
            ...
            framed("09-settings-usage") { SettingsShell(selected: "Usage & billing") { SettingsUsageBilling(account: m.account, activeProfile: m.currentAuthProfile, usage: m.accountUsage) } },
