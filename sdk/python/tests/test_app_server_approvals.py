...
from codewith import ApprovalMode, AsyncCodewith, Codewith
from codewith.generated.v2_all import AskForApprovalValue, ThreadResumeParams
...
def test_thread_resume_inherits_deny_all_approval_mode(tmp_path) -> None:
    ...
    with AppServerHarness(tmp_path) as harness:
        ...
        with Codewith(config=harness.app_server_config()) as codex:
...
def test_async_thread_run_approval_mode_persists_until_explicit_override(
    ...
    async def scenario() -> None:
        ...
        with AppServerHarness(tmp_path) as harness:
            ...
            async with AsyncCodewith(config=harness.app_server_config()) as codex:
