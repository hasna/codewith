...
from codewith.client import CodexClient, _params_dict
from codewith.generated.notification_registry import notification_turn_id
...
def test_generated_v2_bundle_has_single_shared_plan_type_definition() -> None:
    source = (ROOT / "src" / "codewith" / "generated" / "v2_all.py").read_text()
